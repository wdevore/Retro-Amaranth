...
class SOC(Elaboratable):
    ...
    def elaborate(self, platform: Platform) -> Module:
        ...
        # Note: Cat has the "high" bits first followed by "lower" bits, for example,
        # Verilog is: Simm={{21{instr[31]}}, instr[30:25],instr[11:7]};
        # Amaranth is: Cat(instr[7:12], instr[25:31], Repl(instr[31], 21))
        # and of course indices are exclusive.
        ...
        # Note the reverse order of the indices compared to verilog, for example,
        # rs1Id = instr[19:15]; as opposed to below which is 15:20. "20" is used because python
        # is exclusive.
        rs1Id = (instr[15:20])
        rs2Id = (instr[20:25])
        rdId = ( instr[7:12])
        ...
        # Fetch instruction and increase PC in the "slow" domain
        m.d.slow += [
                instr.eq(mem[pc]),
        ...
        def export(signal: Signal, name: str):
